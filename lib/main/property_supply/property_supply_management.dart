...
class PropertySupplyDashboardPage extends StatefulWidget {
  const PropertySupplyDashboardPage({super.key});

  @override
  State<PropertySupplyDashboardPage> createState() =>
      _PropertySupplyDashboardPageState();
}

class _PropertySupplyDashboardPageState
    extends State<PropertySupplyDashboardPage> {
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  userCampus != null
                      ? 'Campus: ${userCampus!.toUpperCase()}  •  Inventory & Maintenance Management'
