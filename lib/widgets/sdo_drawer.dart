...
import 'package:pedalhub_admin/main/sdo/sdo_dashboard.dart';
import 'package:pedalhub_admin/main/sdo/for_approval_page.dart';
import 'package:pedalhub_admin/login_page.dart';

class SDODrawer extends StatelessWidget {
  const SDODrawer({super.key});
            ...
            _AnimatedDrawerItem(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const ForApprovalPage(),
                  ),
                );
              },
            ),
